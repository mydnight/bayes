...
type index struct { //There should be at least two of these -- one each for "good" and "bad" data.
	sync.RWMutex
	m map[string]float64
}

func Parse(text []string, cat1Index string, cat2Index string, tolerance float64) int {
